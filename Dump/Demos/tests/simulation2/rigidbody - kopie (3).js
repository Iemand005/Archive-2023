    ...
    constructor(canvas){
        ...
        class Mouse extends Ball{
            ...
            draw(){
                ...
                //canvas.drawText(Math.round(this.acc[0]) +", "+ Math.round(this.vel[0])+", "+ Math.round(this.pos[0]), this.pos[0], this.pos[1]-20)
                for(var [index, object] of objects.entries()){
                    var circle1 = this, circle2 = object;
                    if(circle2!=circle1){
                        ...
                        if(distance<this.r+circle2.r) object.vel.add(new Vector(xToMove, yToMove)), this.vel.add(new Vector(-xToMove, -yToMove))//this.vel[0] -= xToMove, this.vel[1] -= yToMove, circle2.xv += xToMove, circle2.yv += yToMove;
