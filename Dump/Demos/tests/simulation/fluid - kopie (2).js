                    ...
                    for(var i in this.tiles){
                        for(var j in tiles[i]){
                          // var this = 
                            ...
                            tiles[i][j].vx  += tiles[i][j].vx<0? diff: -diff;
                            tiles[i][j].vy  += tiles[i][j].vy<0? diff: -diff;
                            tiles[i][j].vx0  += tiles[i][j].vx0<0? diff: -diff;
                            tiles[i][j].vy0  += tiles[i][j].vy0<0? diff: -diff;
                        }
                    }
                }
